...
namespace PlagueEngine.Physics.Components
{
    ...
    /****************************************************************************/
    class CylindricalBodyComponent2 : RigidBodyComponent
    {
        ...
        /// Constructor
        /****************************************************************************/
        public CylindricalBodyComponent2(bool enabled, GameObjectInstance gameObject,
                            float mass,
                            float radius,
                            float length,
            ...
            : base( enabled,gameObject, mass, immovable, material, skinTranslation, yaw, pitch, roll)
        {
            ...
            Box supply2 = new Box(Vector3.Transform(sides, Matrix.CreateRotationZ(MathHelper.PiOver4 / 2)),
                Matrix.CreateRotationZ(MathHelper.PiOver4 / 2) , new Vector3(sideLength, sideLength, length));


            Box supply3 = new Box(Vector3.Transform(sides, Matrix.CreateRotationZ(-MathHelper.PiOver4 / 2)),
                Matrix.CreateRotationZ(-MathHelper.PiOver4 / 2), new Vector3(sideLength, sideLength, length));
