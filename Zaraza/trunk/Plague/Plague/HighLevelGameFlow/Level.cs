...
namespace PlagueEngine.HighLevelGameFlow
{
    ...
    class Level
    {
        ...
        public void PutSomeObjects()
        {
            ...
            ParticleEmitterGOData dddtata = new ParticleEmitterGOData();
            dddtata.Type = (typeof(ParticleEmitterGO));
            dddtata.particleTexture = "fire";

            dddtata.maxParticles = 1200;

            dddtata.duration = 2;

            dddtata.minHorizontalVelocity = 0;
            dddtata.maxHorizontalVelocity = 15;

            dddtata.minVerticalVelocity = 10;
            dddtata.maxVerticalVelocity = 10;

            // Create a wind effect by tilting the gravity vector sideways.
            dddtata.gravity = new Vector3(0, 10, 0);

            dddtata.minColor = new Color(255, 255, 255, 10);
            dddtata.maxColor = new Color(255, 255, 255, 40);

            dddtata.minStartSize = 5;
            dddtata.maxStartSize = 10;

            dddtata.minEndSize = 10;
            dddtata.maxEndSize = 40;

            dddtata.initialPosition = new Vector3(245, 54, 35);
            dddtata.particlesPerSecond = 100;
            gameObjectsFactory.Create(dddtata);
